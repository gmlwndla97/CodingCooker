...
public class stick2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stick2);
        ...
        new CountDownTimer(30000,1000){
            ...
            public void onFinish() {
                if(check==false) {
                    ...
                    if ((!(stick2.this).isFinishing()) && ((stick2.this) != null)) {
                        Intent intent=new Intent(stick2.this, stick_timeover.class);
    ...
    public void onSubmitClicked(View v){
        ...
        if(firstimg=="kiwi"&&secondimg=="cherry"&&thirdimg=="pineapple"&&fourthimg=="strawberry"&&fifthimg=="kiwi"){
            Intent intent=new Intent(stick2.this, stick_clear.class);
            startActivity(intent);
            finish();
        }
        else{
            Intent intent=new Intent(stick2.this, stick_fail.class);
            startActivity(intent);
            finish();
        }
