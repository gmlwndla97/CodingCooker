...
public class hamburger3 extends AppCompatActivity {
    //정답은 빵 고기 상추 토마토 상추 치즈 빵
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hamburger3);
        ...
        new CountDownTimer(30000,1000){
            ...
            public void onFinish() {
                if(check==false) {
                    ...
                    if ((!(hamburger3.this).isFinishing()) && ((hamburger3.this) != null)) {
                        Intent intent=new Intent(hamburger3.this, hamburger_timeover.class);
    ...
    public void onClicked(View args){
        ...
        ImageView firstimage=(ImageView) findViewById(R.id.imageView12);
        ImageView secondimage=(ImageView) findViewById(R.id.imageView11);
        ...
        ImageView seventhimage=(ImageView) findViewById(R.id.imageView13);
        ...
        ImageView fourthfood=(ImageView) findViewById(R.id.sixth);
        ImageView fifthfood=(ImageView) findViewById(R.id.fourth);
        ImageView sixthfood=(ImageView) findViewById(R.id.fifth);
        ImageView seventhfood=(ImageView) findViewById(R.id.last);
        count++;
        ...
        if(count==1){
            ...
            if(((ImageButton)args).getId()==R.id.imageButton2){
                ...
                fifthimage.setVisibility(View.VISIBLE);
                fifthfood.setImageResource(R.drawable.bread); //맨 위에 빵 덮는그림으로 바꿔야
            ...
            if(((ImageButton)args).getId()==R.id.imageButton2){
                ...
                sixthimage.setVisibility(View.VISIBLE);
                sixthfood.setImageResource(R.drawable.bread);
            ...
            if(((ImageButton)args).getId()==R.id.imageButton2){
                seventhimage.setImageResource(R.drawable.putbread);
                seventhimage.setVisibility(View.VISIBLE);
                seventhfood.setImageResource(R.drawable.upperbread); //맨 위에 빵 덮는그림으로 바꿔야
                seventhfood.setVisibility(View.VISIBLE);
                seventhimg="bread";
            }
            else if(((ImageButton)args).getId()==R.id.imageButton4){
                seventhimage.setImageResource(R.drawable.putlettuce);
                seventhimage.setVisibility(View.VISIBLE);
                seventhfood.setImageResource(R.drawable.lettuce);
                seventhfood.setVisibility(View.VISIBLE);
                seventhimg="lettuce";
            }
            else if(((ImageButton)args).getId()==R.id.imageButton3){
                seventhimage.setImageResource(R.drawable.putpatty);
                seventhimage.setVisibility(View.VISIBLE);
                seventhfood.setImageResource(R.drawable.patty);
                seventhfood.setVisibility(View.VISIBLE);
                seventhimg="patty";
            }
            else if(((ImageButton)args).getId()==R.id.imageButton){
                seventhimage.setImageResource(R.drawable.putcheese);
                seventhimage.setVisibility(View.VISIBLE);
                seventhfood.setImageResource(R.drawable.cheese);
                seventhfood.setVisibility(View.VISIBLE);
                seventhimg="cheese";
            }
            else if(((ImageButton)args).getId()==R.id.imageButton5){
                seventhimage.setImageResource(R.drawable.puttomato);
                seventhimage.setVisibility(View.VISIBLE);
                seventhfood.setImageResource(R.drawable.tomato);
                seventhfood.setVisibility(View.VISIBLE);
                seventhimg="tomato";
            }
    ...
    public void onBackClicked(View v){
        ...
        if(count==1){
            ...
            seventhimage.setImageResource(R.drawable.question);
            seventhfood.setVisibility(View.INVISIBLE);
            count=6;
        }
        else if(count>7){
            seventhimage.setImageResource(R.drawable.question);
    ...
    public void onSubmitClicked(View v){
        ...
        check=true;
        //빵 고기 상추 토마토 상추 치즈 빵
        if(firstimg=="bread"&&secondimg=="patty"&&thirdimg=="lettuce"&&fourthimg=="tomato"&&fifthimg=="lettuce"&&sixthimg=="cheese"&&seventhimg=="bread"){
            Intent intent=new Intent(hamburger3.this, hamburger_clear.class);
            startActivity(intent);
            finish();
        }
        else{
            Intent intent=new Intent(hamburger3.this, hamburger_fail.class);
            startActivity(intent);
            finish();
        }
