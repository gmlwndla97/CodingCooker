...
public class mandu_timeover extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mandu_timeover);
        ...
        ReStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mandu_timeover.this, manduhint.class);
        ...
        StopGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clicksound.play(soundId2,3f,3f,0,0,1f);
                Intent intent = new Intent(mandu_timeover.this, menu.class);
                startActivity(intent);
                finish();
            }
        });
