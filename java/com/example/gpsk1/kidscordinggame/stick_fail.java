...
public class stick_fail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stick_fail);
    ...
    public void onClicked(View args) {
        ...
        if(((ImageButton)args).getId()==R.id.restart){
            if(number==1){
                Intent intent=new Intent(stick_fail.this, stickhint1.class);
                startActivity(intent);
            }
            if(number==2){
                Intent intent=new Intent(stick_fail.this, stickhint2.class);
                startActivity(intent);
            }
            if(number==3){
                Intent intent=new Intent(stick_fail.this, stickhint3.class);
                startActivity(intent);
            }
            finish();
        }
        else if(((ImageButton)args).getId()==R.id.stop){
            Intent intent=new Intent(stick_fail.this, menu.class);
            startActivity(intent);
            finish();
        }
    }
